...
void NuevaLinea();
void NuevaMuestra();
void GuardarMuestra(unsigned char* trama, unsigned short tramaSize);
...
void NuevaLinea(){
	...
	if (banInicio==1){
		GuardarMuestra(tramaDatos,(15+(NUM_MUESTRAS*10)));                      //Guarda la muestra en cada inicio de linea
	}
