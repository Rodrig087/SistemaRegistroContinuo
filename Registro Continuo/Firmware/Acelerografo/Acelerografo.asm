...
; j start address is: 4 (W2)
	CP.B	W2, #9
	BRA LTU	L__ADXL355_read_data78
...
; j start address is: 4 (W2)
	CP.B	W2, #9
	BRA LTU	L__ADXL355_read_data79
...
L_Timer1Int42:
	...
	MOV	#lo_addr(_x), W0
	CP	W2, [W0]
	BRA GTU	L__Timer1Int94
	GOTO	L_Timer1Int43
L__Timer1Int94:
;Acelerografo.c,213 :: 		if ((x==0)||(x%9==0)){
	MOV	_x, W0
	CP	W0, #0
	BRA NZ	L__Timer1Int95
	GOTO	L__Timer1Int66
L__Timer1Int95:
	MOV	_x, W0
	MOV	#9, W2
