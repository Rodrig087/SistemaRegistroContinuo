...
;CPComunicacion.c,96 :: 		PIR1.TMR1IF = 0;                                  //Limpia la bandera de interrupcion del TMR1
	BCF         PIR1+0, 0 
;CPComunicacion.c,97 :: 		PIE1.TMR1IE = 1;                                  //Habilita la interrupción de desbordamiento TMR1
	BSF         PIE1+0, 0 
...
;CPComunicacion.c,102 :: 		PIR1.TMR2IF = 0;                                  //Limpia la bandera de interrupcion del TMR2
	BCF         PIR1+0, 1 
;CPComunicacion.c,103 :: 		PIE1.TMR2IE = 1;                                  //Habilita la interrupción de desbordamiento TMR2
	BSF         PIE1+0, 1 
