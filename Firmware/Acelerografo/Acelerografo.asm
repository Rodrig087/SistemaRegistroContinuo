...
; j start address is: 4 (W2)
	CP.B	W2, #9
	BRA LTU	L__ADXL355_read_data263
...
;Acelerografo.c,85 :: 		GPS_init();                                                                //Inicializa el GPS
	CALL	_GPS_init
...
L_main49:
;Acelerografo.c,144 :: 		Delay_ms(100);
	MOV	#13, W8
	MOV	#13575, W7
L_main51:
	DEC	W7
...
L_Muestrear67:
	...
	MOV	#lo_addr(_x), W0
	CP	W2, [W0]
	BRA GTU	L__Muestrear309
	GOTO	L_Muestrear68
L__Muestrear309:
;Acelerografo.c,279 :: 		if ((x==0)||(x%9==0)){
	MOV	_x, W0
	CP	W0, #0
	BRA NZ	L__Muestrear310
	GOTO	L__Muestrear191
L__Muestrear310:
	MOV	_x, W0
	MOV	#9, W2
	REPEAT	#17
	...
	MOV	W1, W0
	CP	W0, #0
	BRA NZ	L__Muestrear311
	GOTO	L__Muestrear190
L__Muestrear311:
	GOTO	L_Muestrear72
L__Muestrear191:
L__Muestrear190:
...
L_Timer1Int133:
	...
	MOV	#lo_addr(_x), W0
	CP	W2, [W0]
	BRA GTU	L__Timer1Int352
	GOTO	L_Timer1Int134
L__Timer1Int352:
;Acelerografo.c,496 :: 		if ((x==0)||(x%9==0)){
	MOV	_x, W0
	CP	W0, #0
	BRA NZ	L__Timer1Int353
	GOTO	L__Timer1Int241
L__Timer1Int353:
	MOV	_x, W0
	MOV	#9, W2
	REPEAT	#17
	...
	MOV	W1, W0
	CP	W0, #0
	BRA NZ	L__Timer1Int354
	GOTO	L__Timer1Int240
L__Timer1Int354:
	GOTO	L_Timer1Int138
L__Timer1Int241:
L__Timer1Int240:
