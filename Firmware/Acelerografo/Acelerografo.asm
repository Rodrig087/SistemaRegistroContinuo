...
L_ADXL355_init2:
	CP.B	W10, #1
	BRA NZ	L__ADXL355_init215
	GOTO	L_ADXL355_init4
L__ADXL355_init215:
	CP.B	W10, #2
	BRA NZ	L__ADXL355_init216
...
;adxl355_spi.c,151 :: 		if((ADXL355_read_byte(Status)&0x01)==1){                                 //Verifica que el bit DATA_RDY del registro Status este en alto
	...
	AND	W0, #1, W0
	CP	W0, #1
	BRA Z	L__ADXL355_read_data222
	GOTO	L_ADXL355_read_data8
L__ADXL355_read_data222:
...
; j start address is: 4 (W2)
	CP.B	W2, #9
	BRA LTU	L__ADXL355_read_data223
	GOTO	L_ADXL355_read_data10
L__ADXL355_read_data223:
...
; j start address is: 4 (W2)
	CP.B	W2, #9
	BRA LTU	L__ADXL355_read_data224
...
;tiempo_rtc.c,197 :: 		if (dia<28){
	CP	W0, #28
	CPB	W1, #0
	BRA LTU	L__IncrementarFecha236
...
; dia start address is: 12 (W6)
	CP	W6, #30
	CPB	W7, #0
	BRA LTU	L__IncrementarFecha240
...
L_Muestrear67:
	...
	MOV	#lo_addr(_x), W0
	CP	W2, [W0]
	BRA GTU	L__Muestrear269
	GOTO	L_Muestrear68
L__Muestrear269:
;Acelerografo.c,279 :: 		if ((x==0)||(x%9==0)){
	MOV	_x, W0
	CP	W0, #0
	BRA NZ	L__Muestrear270
	GOTO	L__Muestrear163
L__Muestrear270:
	MOV	_x, W0
	MOV	#9, W2
	REPEAT	#17
	...
	MOV	W1, W0
	CP	W0, #0
	BRA NZ	L__Muestrear271
	GOTO	L__Muestrear162
L__Muestrear271:
	GOTO	L_Muestrear72
L__Muestrear163:
L__Muestrear162:
...
L_Timer1Int133:
	...
	MOV	#lo_addr(_x), W0
	CP	W2, [W0]
	BRA GTU	L__Timer1Int312
	GOTO	L_Timer1Int134
L__Timer1Int312:
;Acelerografo.c,496 :: 		if ((x==0)||(x%9==0)){
	MOV	_x, W0
	CP	W0, #0
	BRA NZ	L__Timer1Int313
	GOTO	L__Timer1Int213
L__Timer1Int313:
	MOV	_x, W0
	MOV	#9, W2
	REPEAT	#17
	...
	MOV	W1, W0
	CP	W0, #0
	BRA NZ	L__Timer1Int314
	GOTO	L__Timer1Int212
L__Timer1Int314:
	GOTO	L_Timer1Int138
L__Timer1Int213:
L__Timer1Int212:
