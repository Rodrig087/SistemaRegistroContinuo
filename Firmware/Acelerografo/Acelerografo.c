...
// Varible para arreglar ese problema absurdo >:C
char banInicializar;
...
void ConfiguracionPrincipal()
{
   ...
   TRISA0_bit = 0;  // Sensor corriente *no utilizado*
   TRISA1_bit = 0;  // Sensor tension *no utilizado*
   TRISA2_bit = 0;  // CS1
   TRISA3_bit = 0;  // CS2
   TRISA4_bit = 0;  // RPI1
   TRISB4_bit = 0;  // RPI2
   TRISB12_bit = 0; // Led Test
   ...
   IPC2bits.U1RXIP = 0x04;   // Prioridad de la interrupcion UART1 RX (1-7, 7=>mas alta)
