...
void RecuperarVector() {
	...
	char *entrada = (char*)malloc(strlen(nombreArchivo)+5+13);
	char *salida = (char*)malloc(strlen(nombreArchivo)+5+13);
	...
	//Se salta el numero de minutos que indique la variable tiempoInicial:
